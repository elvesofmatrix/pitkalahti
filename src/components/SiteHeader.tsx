      ...
      >
        <Link href={`${pathFor(locale)}#top`} className="relative block h-[3.25rem] w-[8.5rem] shrink-0 sm:h-14 sm:w-[10.5rem] lg:w-[11.5rem]" aria-label="Pitkälahti home">
          <Image
            ...
            height={216}
            priority
            className="absolute left-0 top-1/2 w-[7.75rem] origin-left -translate-y-1/2 object-contain transition-[opacity,transform] duration-300 motion-reduce:transition-none [--full-logo-drop:40px] sm:w-[9.25rem] lg:w-[10.5rem] lg:[--full-logo-drop:45px]"
            style={{
